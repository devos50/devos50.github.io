...
I also have a small company named [CodeUp](https://code-up.nl). My primary business activity is the development of mobile application (iOS/Android) and web- and email hosting. You can find more information about these activities on the website of [CodeUp](https://code-up.nl). Furthermore, I also develop customized enterprise applications, which you can find more information about [here](https://codeup-flow.nl) (website in Dutch).

Besides my professional activities, I enjoy travelling, snowboarding, bouldering, running and software reverse engineering. One of my projects involve the emulation of legacy Apple devices (an iPod Touch 1G and 2G), which source code can be found [here](https://github.com/devos50/qemu-ios).

You can find my curriculum vitae [here](assets/pdf/resume.pdf){:target="_blank"}.

**Services:**

- 2026: [Middleware](https://middleware-conf.github.io/2026/) (PC), [InSyDe](https://sites.google.com/view/insyde-eurosys26/home) (PC), [ICML](https://icml.cc/Conferences/2026) (PC), [NeurIPS](https://neurips.cc/Conferences/2026) (PC), [BRAINS](https://brains.dnac.org/2026/) (PC), [EMNLP](https://2026.emnlp.org) (PC), [CODEC-FM](https://collaborative-open-decentralized-fomo.github.io) (PC), [SatML](https://satml.org) (PC)
- 2025: [FGCS](https://www.sciencedirect.com/journal/future-generation-computer-systems), [Computers in Biology and Medicine](https://www.sciencedirect.com/journal/computers-in-biology-and-medicine), [Cluster Computing](https://link.springer.com/journal/10586), [Neurocomputing](https://www.sciencedirect.com/journal/neurocomputing), [Expert Systems with Applications](https://www.sciencedirect.com/journal/expert-systems-with-applications), [NeurIPS](https://neurips.cc/Conferences/2025) (PC), [Computer Networks](https://www.sciencedirect.com/journal/computer-networks), [SatML](https://satml.org) (PC).
